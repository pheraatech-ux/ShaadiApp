...
export function TeamPageView({
  ...
  return (
    <div className="space-y-5">
      ...
      {/* TODO: overdue tasks alert — "X tasks are overdue. Send reminders from member profiles."
      ...
      */}
      <TeamMembersTable
        ...
        showActionsColumn={canManageTeam}
        onInviteClick={canManageTeam ? () => setInviteOpen(true) : undefined}
        ...
        onMessageMember={
          canManageTeam
            ? async (memberId) => {
                ...
                router.push(`${basePath}/weddings/${data.weddingSlug}/messages?thread=${data.threadId}`);
              }
            : undefined
        }
        onCopyInviteLink={
